...
| `kasane-wit/` | Canonical Kasane plugin WIT (`kasane:plugin`) — single owner of `wit/plugin.wit`; host + SDK + SDK-macros depend on it (γ-0.4) |
