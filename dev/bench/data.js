    ...
    "Kasane Rendering Pipeline": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "dfbfe9051f10bd1006f67c286a5a47eb1425524f",
          "message": "refactor(plugin): unify Plugin/PurePlugin naming — PurePlugin becomes Plugin (ADR-022)\n\nRename the dual-trait plugin system to make PurePlugin the primary\nuser-facing API and demote the old mutable Plugin to an internal trait:\n\n- PurePlugin → Plugin (primary, state-externalized, pure functions)\n- Plugin → PluginBackend (#[doc(hidden)], mutable, internal)\n- PurePluginBridge → PluginBridge\n- IsPurePlugin → IsBridgedPlugin\n- ErasedPurePlugin → ErasedPlugin\n- register_pure() → register()\n- register(Box<dyn Plugin>) → register_backend(Box<dyn PluginBackend>)\n\nMigrates examples/line-numbers to the new Plugin trait, updates proc\nmacro codegen, all tests (~660), benchmarks, and documentation.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T14:27:38+09:00",
          "tree_id": "eca03b2b1fa15e65542aed7ce1ebc83941e68c53",
          "url": "https://github.com/Yus314/kasane/commit/dfbfe9051f10bd1006f67c286a5a47eb1425524f"
        },
        "date": 1773640497617,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "11900a5051b34d0c3a0a81fde7f35196376ac453",
          "message": "docs: reposition bundled plugins as examples and improve documentation\n\nMove WASM example plugins from kasane-wasm/guests/ to examples/wasm/\nto clearly communicate they are reference implementations, not core\nfeatures. Move wasm-test to tools/ as it is a development tool, not\na user-facing example.\n\nDocumentation reframed throughout: \"bundled plugin\" → \"example plugin\",\nplugin system capabilities emphasized over individual plugin listings.\n\n- Move 5 WASM guests to examples/wasm/ (same depth, no path changes in guest code)\n- Move wasm-test to tools/wasm-test/\n- Add CONTRIBUTING.md with dev setup and guidelines\n- Add CI and license badges to README.md\n- Update README, whats-different, using-plugins, plugin-development,\n  glossary, layer-responsibilities, decisions, repo-layout, config,\n  CLAUDE.md to reflect new structure and example framing\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T15:01:39+09:00",
          "tree_id": "870a06fee84cbb5bb02d282dcc668befa33dd6bd",
          "url": "https://github.com/Yus314/kasane/commit/11900a5051b34d0c3a0a81fde7f35196376ac453"
        },
        "date": 1773642504065,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "763f8d3c441ff24b730b5f251cc479c50322a223",
          "message": "fix(core): add MENU_STRUCTURE to info overlay cache deps + deterministic plugin ordering\n\nFix a cache invalidation bug where info overlay positions were not\nrecalculated when menus appeared/disappeared, causing potential visual\noverlap. Also make plugin contribution ordering fully deterministic by\ntie-breaking on plugin_id at all sort sites, add PaintPatch correctness\ndocumentation, and add menu+info combination tests.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T15:40:02+09:00",
          "tree_id": "d58c5509145c4116ed075537d5a45d6d442fb05a",
          "url": "https://github.com/Yus314/kasane/commit/763f8d3c441ff24b730b5f251cc479c50322a223"
        },
        "date": 1773644818166,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c3163521db8efc812f3cfce5ec0ac238dcbe249f",
          "message": "feat(sdk): add #[plugin] proc macro to auto-fill Guest trait defaults\n\nIntroduces kasane-plugin-sdk-macros crate with a #[kasane_wasm_plugin]\nattribute macro (re-exported as kasane_plugin_sdk::plugin) that\nautomatically generates default implementations for all unimplemented\nGuest trait methods. This eliminates 20-28 lines of default_*!() macro\nboilerplate per WASM plugin.\n\nAll 5 example WASM plugins migrated to use #[plugin]. Bundled .wasm\nfiles rebuilt.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T15:59:41+09:00",
          "tree_id": "c2ea6fd96cf6c43583d6cd632b4cb49ce74d7a10",
          "url": "https://github.com/Yus314/kasane/commit/c3163521db8efc812f3cfce5ec0ac238dcbe249f"
        },
        "date": 1773646002896,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c4f26fc22628581923db575b0558fd6647c4ff4e",
          "message": "fix(wasm): bundled plugin tests — add enabled list and respect disabled config\n\nTests were missing the required `enabled` list (bundled plugins are\nopt-in) and `register_bundled_plugins` was not checking the `disabled`\nlist. Both issues fixed.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T16:02:00+09:00",
          "tree_id": "f8802d341c772282d5f72426e8f9a31d13e1970e",
          "url": "https://github.com/Yus314/kasane/commit/c4f26fc22628581923db575b0558fd6647c4ff4e"
        },
        "date": 1773646129098,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c4be85ada5e64131dd2d11bd160dd61b25914b35",
          "message": "docs: rewrite plugin-development.md for WASM-first experience\n\nRestructure the plugin development guide based on thorough review:\n\n- Make WASM the primary (and only Quick Start) path; move Native\n  Plugin and PluginBackend to appendices\n- Remove legacy API implementations (contribute, contribute_line,\n  contribute_overlay, slot_deps) from all WASM example plugins,\n  keeping only current APIs (contribute_to, annotate_line,\n  contribute_overlay_v2, contribute_deps)\n- Condense §1 Introduction from 52 lines to a focused intro\n  paragraph + \"What Plugins Can Do\" table\n- Remove §3 Further Reading (all items pointed to plugin-api.md);\n  use inline links instead\n- Promote Testing to its own section after Quick Start\n- Remove advanced paragraphs (display transformation roadmap,\n  Session API details, Surface security model) that already exist\n  in plugin-api.md\n- Update Quick Start example to use #[plugin] proc macro\n- Add legacy API footnote in Appendix C\n- Fix outdated CLAUDE.md claim about Japanese documentation\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T16:08:03+09:00",
          "tree_id": "c4d7560d03defc22bc23f2adf8030fbcc39e52b8",
          "url": "https://github.com/Yus314/kasane/commit/c4be85ada5e64131dd2d11bd160dd61b25914b35"
        },
        "date": 1773646490371,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "468cf0cef0c22b38d1df1af3f1eb86d4d283f711",
          "message": "refactor(render): unify dual paint pipeline via Visitor pattern\n\nReplace duplicated Element tree traversal in paint.rs (TUI → CellGrid)\nand scene/mod.rs (GPU → DrawCommand) with a single generic walk_paint<V>()\nthat dispatches to PaintVisitor implementations at 7 divergence points.\n\n- Add walk.rs with PaintVisitor trait, GridPaintVisitor, ScenePaintVisitor\n- Route pipeline.rs through walk_paint for both TUI and GPU paths\n- Delegate paint()/scene_paint() to walk_paint internally\n- Remove ~480 lines of duplicated traversal code (paint_with_ctx,\n  scene_paint_inner, ContainerPaintArgs, ContainerStyle, etc.)\n- 14 cross-validation tests verify identical output vs old pipelines\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T16:23:38+09:00",
          "tree_id": "9db01efc15672da3cf6cf62e12704b22e2f83e08",
          "url": "https://github.com/Yus314/kasane/commit/468cf0cef0c22b38d1df1af3f1eb86d4d283f711"
        },
        "date": 1773647411950,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b8272eff5408d7b532d5ae8d5085218616fe6b38",
          "message": "feat(gui): add DecorationPipeline for text decoration rendering (R-053)\n\nAdd GPU rendering of underline variants (solid, curly, double),\nunderline color, and strikethrough to the GUI backend via a dedicated\nDecorationPipeline rendered after the text pass.\n\n- decoration.wgsl: procedural shader with solid line, sine-wave curly,\n  and double-line fragment outputs with smoothstep anti-aliasing\n- decoration_pipeline.rs: instanced rendering pipeline (10 floats/instance)\n- scene_renderer.rs: emit_decorations() extracts Face.attributes and\n  Face.underline from DrawAtoms/DrawText, pushes decoration instances\n- Update roadmap and requirements-traceability for R-053 completion\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T16:48:56+09:00",
          "tree_id": "427e88a6be60d22dc85a7bfab75e9c1bd921bda3",
          "url": "https://github.com/Yus314/kasane/commit/b8272eff5408d7b532d5ae8d5085218616fe6b38"
        },
        "date": 1773648945879,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "651b970c96a8b38c5663ea5b15055c6956c68196",
          "message": "feat(examples): replace line-numbers with prompt-highlight transform example\n\nReplace the WASM line-numbers example (redundant contribute_to coverage\nwith sel-badge) with prompt-highlight, the first transform_element()\nexample. This fills the last uncovered slot among the 4 main plugin\nextension mechanisms.\n\nprompt-highlight wraps the status bar in a highlighted container when\nthe editor enters prompt mode, demonstrating the wrap/passthrough\npattern, TransformTarget routing, and transform_deps caching.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T16:56:53+09:00",
          "tree_id": "a455e54b99588089b21e76df8e0b924285877f30",
          "url": "https://github.com/Yus314/kasane/commit/651b970c96a8b38c5663ea5b15055c6956c68196"
        },
        "date": 1773649441764,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "8900755a2c1726d7a690951a55e04fb81d981d7d",
          "message": "fix(render): MenuSelect dirty flags bug + PaintPatch property tests\n\nFix MenuSelect to return MENU_STRUCTURE when scrolling occurs (first_item\nchanges), preventing MenuSelectionPatch from incorrectly applying on\nscroll. Add comprehensive proptest-based property tests for all three\nPaintPatch implementations (StatusBar, MenuSelection, Cursor), guard\nsoundness verification, multi-frame composition, and region isolation.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T17:38:55+09:00",
          "tree_id": "96fef4feeafae915695b33bc024ddc549c9ffdf8",
          "url": "https://github.com/Yus314/kasane/commit/8900755a2c1726d7a690951a55e04fb81d981d7d"
        },
        "date": 1773651926022,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "f7f86f8d2c39c9bed32bd5e25a19f1b186656e64",
          "message": "feat(sdk): prepare kasane-plugin-sdk for crates.io publish\n\nConvert generate! macro from macro_rules to proc macro with embedded WIT,\nenabling external consumers to use `kasane_plugin_sdk::generate!()` without\nneeding the monorepo. Add crates.io metadata, LICENSE files, READMEs,\nWIT three-way sync test, slot name sync test, and CI WIT diff check.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T17:44:36+09:00",
          "tree_id": "d88237570860d27af117057f2b5ff1958ae6423d",
          "url": "https://github.com/Yus314/kasane/commit/f7f86f8d2c39c9bed32bd5e25a19f1b186656e64"
        },
        "date": 1773652443551,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "a824fe1bcd16183b2d453de8134cd0a26ddb059e",
          "message": "feat(session): add session observability infrastructure (ADR-023 step 1)\n\nImplement core-side session management infrastructure so plugins can\nobserve and control sessions. This is the mechanism layer of ADR-023's\nmechanism/policy split.\n\nCore changes:\n- DirtyFlags::SESSION (bit 8) for session lifecycle notifications\n- AppState.session_descriptors / active_session_key for observation\n- SessionDescriptor type and SessionCommand::Switch variant\n- sync_session_metadata() and switch_session_core() event loop helpers\n- SessionRuntime::switch_session in TUI and GUI backends\n- SESSION dirty flag set on spawn, close, switch, and session death\n\nWASM / SDK changes:\n- WIT v0.6.0 → v0.7.0: session-descriptor record, switch-session\n  command, Tier 8 host-state functions (get-session-count, get-session,\n  get-active-session-key)\n- HostState session fields + Host trait impl + sync_from_app_state\n- SDK dirty::SESSION constant\n- Bundled and fixture .wasm binaries rebuilt for WIT v0.7.0\n\nMacro / analysis:\n- SESSION added to KNOWN_FLAGS, FIELD_FLAG_MAP, expand_single_flag\n\nDocumentation:\n- ADR-023 status Proposed → Current, step 1 marked done\n- semantics.md §12.9, plugin-api.md §3.5.1, layer-responsibilities.md\n  infrastructure table updated to reflect implementation\n- roadmap.md §3.1/§3.2 current status updated\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T18:13:02+09:00",
          "tree_id": "485d58cde235607dd09d85c679f90bd434a148d2",
          "url": "https://github.com/Yus314/kasane/commit/a824fe1bcd16183b2d453de8134cd0a26ddb059e"
        },
        "date": 1773654059055,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "884924b0d15da395d25ffdb5b97ff853bcdf8621",
          "message": "feat(session): enrich session descriptors with buffer_name and mode_line\n\nAdd buffer_name and mode_line to SessionDescriptor, extracted from\nstored session state. Remove session_id from SurfaceRegistry (API\nwas committed with 2-arg callers, fixing the mismatch). Update WASM\nhost to use SessionDescriptorCache for enriched descriptor sync.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T19:20:32+09:00",
          "tree_id": "e4d16d18b3884c590547afba3178306dffd6b3a5",
          "url": "https://github.com/Yus314/kasane/commit/884924b0d15da395d25ffdb5b97ff853bcdf8621"
        },
        "date": 1773658159928,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "ac6b52e634604c95d1c3b62b3b07973f3ef63fbc",
          "message": "docs(core): document parallel menu/info implementations\n\nAdd module-level notes to surface/menu.rs and surface/info.rs explaining\nthe intentional parallel between the Surface path (render::view) and the\nSalsa pipeline path (salsa_views). Helps future contributors understand\nthe dual-path design before consolidation.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T22:08:50+09:00",
          "tree_id": "695182916b72870b5ed4fa3df058de4486ed013f",
          "url": "https://github.com/Yus314/kasane/commit/ac6b52e634604c95d1c3b62b3b07973f3ef63fbc"
        },
        "date": 1773668211993,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "be9574a9ef57081f04bf6ddbb1a7167a16cd6537",
          "message": "docs: add WASM plugin constraints document\n\nCreate docs/wasm-constraints.md cataloging all WASM plugin\nlimitations with labels: [By Design], [Not Yet Implemented],\n[Improvement]. Organized by category: extension point gaps,\nhost state access, command API, runtime constraints, and\ndeveloper experience. Includes rationale and evolution path\nwith roadmap references.\n\nAdd cross-references from plugin-api.md, plugin-development.md,\nand index.md.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T22:11:39+09:00",
          "tree_id": "601fbc86b3abfa7f4f9943bcf0ba5dc40f135b12",
          "url": "https://github.com/Yus314/kasane/commit/be9574a9ef57081f04bf6ddbb1a7167a16cd6537"
        },
        "date": 1773668327635,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "895f69c13299bfbdb0728dc669cfdcd52492b853",
          "message": "docs: update plugin docs with SDK helpers reference\n\n- plugin-development.md: update Quick Start examples to use new API\n  (auto-imports, default_face(), face() helpers)\n- plugin-api.md: add §4.4 SDK Helpers section covering Face/Color\n  construction, overlay layout, key escaping, attributes, state!\n  macro, and auto imports\n- wasm-constraints.md: mark SendKeys escaping and state hash as\n  resolved, update code examples\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T23:00:34+09:00",
          "tree_id": "572a580476046632aec18812103a9def3909a365",
          "url": "https://github.com/Yus314/kasane/commit/895f69c13299bfbdb0728dc669cfdcd52492b853"
        },
        "date": 1773671340838,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "94a00050ed226de9c991d37df18e7b659f2496af",
          "message": "feat(sdk): improve WASM plugin SDK ergonomics with macros and helpers\n\nAdd six new SDK features that reduce plugin boilerplate:\n- Phase A: `state!` macro auto-generates `state_hash()` via generation counter\n- Phase B: Convenience constructors (`bg_annotation`, `auto_contribution`,\n  `edges`, `container()` builder, `text()`, `column()`, etc.)\n- Phase C: `slots!` macro unifying `contribute_to` + `contribute_deps`\n- Phase D: `ContainerBuilder` with fluent `.border().shadow().padding().build()`\n- Phase E: `interactive_id!` macro for type-safe ID encoding/decoding\n- Phase F: `JobTracker` helper for async job stale-result detection\n\nUpdate all 6 example plugins to use the new helpers. Rebuild WASM fixtures.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-16T23:51:01+09:00",
          "tree_id": "93018cd702b83f740b1f6d0776b798ec788d833c",
          "url": "https://github.com/Yus314/kasane/commit/94a00050ed226de9c991d37df18e7b659f2496af"
        },
        "date": 1773674330698,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "00c93f88728ad52f5b4fc6159662ac89d100c51e",
          "message": "feat(session): fix session lifecycle bugs and complete multi-session UI parity\n\nFix three session-related bugs:\n- Add `send_initial_resize` recovery after deferred session commands\n  (Spawn/Close/Switch) to prevent permanent input suppression\n- Add `on_state_changed(SESSION)` plugin notification after deferred\n  session commands so plugins update cached session metadata\n- Deduplicate session keys before process spawn in `spawn_session_core`\n  to avoid orphaning Kakoune processes on duplicate keys\n\nAlso:\n- Extend WIT `session-descriptor` with `buffer-name` and `mode-line`\n- Add resize recovery and plugin notification to KakouneDied handlers\n  in both TUI and GUI backends\n- Widen `send_initial_resize` to accept `&mut (impl Write + ?Sized)`\n- Register session_ui WASM fixture tests (14 tests)\n- Clean up diagnostic tracing (remove verbose debug logs, demote\n  input event logging to trace level)\n- Update roadmap: mark \"Multi-session UI parity\" as complete\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T00:07:26+09:00",
          "tree_id": "8000c8a7bc0e80e1288322d3f193d77dee8dfa6d",
          "url": "https://github.com/Yus314/kasane/commit/00c93f88728ad52f5b4fc6159662ac89d100c51e"
        },
        "date": 1773675483960,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "2655368dcda8bfbe80a3b21bc35db2a9821fb1b3",
          "message": "feat(cli): add `kasane plugin` subcommand for WASM plugin workflow\n\nIntroduce `kasane plugin new|build|install|list` to streamline the WASM\nplugin development workflow from 7 manual steps to 3 commands.\n\n- `new`: scaffold project with contribution/annotation/transform templates\n- `build`: compile to wasm32-wasip2 with cargo JSON output parsing\n- `install`: build + validate via WasmPluginLoader + copy to plugins dir\n- `list`: show installed plugins with IDs from WASM runtime\n\nUpdate plugin-development.md, using-plugins.md, and repo-layout.md to\ndocument the new commands.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T03:15:00+09:00",
          "tree_id": "95613c6e48daaa7aa36d5855c53bdd36a8b06085",
          "url": "https://github.com/Yus314/kasane/commit/2655368dcda8bfbe80a3b21bc35db2a9821fb1b3"
        },
        "date": 1773686538938,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "209f021e663e9a5e317f8a62deda7b2fa04df3a2",
          "message": "docs: update plugin docs for new commands, macros, and display transform\n\n- plugin-development.md: add define_plugin! macro section, overlay/process\n  templates, kasane plugin dev/doctor commands, display_directives profile\n- plugin-api.md: add DISPLAY_TRANSFORM capability, display_directives_deps\n- repo-layout.md: add kasane-plugin-sdk-macros crate, session-ui example,\n  doctor.rs/dev.rs in plugin_cmd tree\n- CLAUDE.md: add kasane-plugin-sdk-macros to workspace table, session-ui\n  to examples list\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T04:05:14+09:00",
          "tree_id": "d1357742900117a5d87507747c4bfd817a3d6b09",
          "url": "https://github.com/Yus314/kasane/commit/209f021e663e9a5e317f8a62deda7b2fa04df3a2"
        },
        "date": 1773689520343,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "61f32161a6a2750423f1ded241cbcaaa04853848",
          "message": "feat(sdk): lower plugin authoring barrier with helpers, hello template, and DX improvements\n\n- Add 7 SDK helpers: plain(), colored(), is_ctrl(), is_alt(), is_ctrl_shift(),\n  status_badge(), hex() — emitted by generate!()/define_plugin!\n- Fix define_plugin! to auto-import dirty, modifiers, keys, attributes modules\n- Add --template hello (4-line minimal plugin) to kasane plugin new\n- Convert all 5 templates (contribution, annotation, transform, overlay, process)\n  from generate!()+#[plugin]+export!() to define_plugin! format\n- kasane plugin dev: default to debug builds, add --release flag\n- kasane plugin doctor --fix: auto-install wasm32-wasip2 target and create\n  plugins directory\n- Improve WIT mismatch error to include Kasane version\n- Update plugin-development.md, using-plugins.md, SDK README and doc comments\n  to lead with define_plugin! and document new helpers\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T04:59:43+09:00",
          "tree_id": "41f3e0cbf505e00e75d5256777448e9343d642c6",
          "url": "https://github.com/Yus314/kasane/commit/61f32161a6a2750423f1ded241cbcaaa04853848"
        },
        "date": 1773692785785,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "a020c3b427f6e5618430972a94206f0638941786",
          "message": "fix(protocol): support rgba: colors and improve cursor detection for third-party themes\n\nThird-party Kakoune themes (e.g. anhsirk0/kakoune-themes) use rgba:RRGGBBAA\ncolors for PrimarySelection/SecondarySelection faces. Kakoune's JSON UI sends\nthese as-is when the base face has a Default background (no alpha blending\noccurs). Kasane's parse_color() only handled rgb:RRGGBB, causing the entire\ndraw message to fail deserialization — making selections invisible.\n\nFix: parse rgba:RRGGBBAA by stripping the alpha channel (terminals don't\nsupport alpha). The rgba: check runs before rgb: to avoid prefix confusion.\n\nAlso improve cursor detection: themes that omit +rfg from PrimaryCursor face\nbypassed the FINAL_FG|REVERSE heuristic. Add a face-matching fallback that\nuses the primary cursor position (from protocol) to identify the cursor face,\nthen scans for secondary cursors with the same foreground color.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T06:03:39+09:00",
          "tree_id": "95d8af367e4a2923c7df9200e910a52586460e32",
          "url": "https://github.com/Yus314/kasane/commit/a020c3b427f6e5618430972a94206f0638941786"
        },
        "date": 1773696644969,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "e3e043c9bea8674542469d64a652a4c97c355021",
          "message": "feat(sdk): improve define_plugin! DX with #[bind], auto state access, and StateMutGuard\n\n- Add #[bind(expr, on: flags)] attribute on state fields to auto-generate\n  on_state_changed sync code, eliminating manual boilerplate\n- Auto-inject `state.field` read access in slots closures (no more\n  STATE.with(|s| s.borrow().field) needed)\n- Add simple slot form `SLOT => expr` that auto-wraps in auto_contribution()\n- Add StateMutGuard that auto-calls bump_generation() on drop in mutable\n  contexts (handle_key, overlay, on_io_event, etc.)\n- Auto-append vec![] in on_state_changed; add on_state_changed_commands\n  escape hatch for returning commands\n- Add redraw(), redraw_flags(), send_command() helpers to SDK\n- Generate slots code directly instead of delegating to slots! macro\n- Update all 6 plugin templates to use new syntax\n- Update plugin-development.md, plugin-api.md, and SDK README\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T06:12:09+09:00",
          "tree_id": "2ef500db4a94a31fa55e1f8dbc20325697345be9",
          "url": "https://github.com/Yus314/kasane/commit/e3e043c9bea8674542469d64a652a4c97c355021"
        },
        "date": 1773697162696,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "7c0a6e9091fefab3ed3cfb4c49a0398b87b1783d",
          "message": "feat(display): add DisplayMap foundation with virtual text support\n\nIntroduce DisplayMap — a bidirectional O(1) mapping between buffer lines\nand display lines — enabling plugins to declare display transformations\n(fold, virtual text insertion, hide) via DisplayDirective.\n\nCore changes:\n- DisplayMap, DisplayDirective, SourceMapping, InteractionPolicy types\n- Plugin API: display_directives() and display_directives_deps() on\n  Plugin/PluginBackend traits with DISPLAY_TRANSFORM capability\n- Full rendering pipeline integration: paint, cursor, input, patch,\n  Salsa path (compose_base_with_plugins)\n- Fix: synthetic lines (virtual text) always repainted regardless of\n  lines_dirty optimization to prevent disappearing after grid.clear()\n\nProof artifact: examples/virtual-text-demo/ — detects TODO/FIXME/HACK/NOTE\nkeywords and inserts colored virtual text annotations (toggle with 'z').\n\nDocs: updated plugin-api.md, plugin-development.md, architecture.md,\nroadmap.md, semantics.md, requirements-traceability.md, decisions.md,\nCLAUDE.md with DisplayMap API reference and implementation status.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T06:24:02+09:00",
          "tree_id": "8cbc3d9e9b304acb8f6fab7bcb687c092a3edb30",
          "url": "https://github.com/Yus314/kasane/commit/7c0a6e9091fefab3ed3cfb4c49a0398b87b1783d"
        },
        "date": 1773697869257,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c50f1cbbac35c4db35fb9b9c120d60f21de85b9e",
          "message": "docs: remove kakoune-issues-investigation.md (demand evidence absorbed into existing docs)\n\nThe document served as founding-era demand evidence linking Kakoune\nissues to Kasane features. Its content has been fully absorbed:\npriority rankings into roadmap planning, feature positioning into\nwhats-different/plugin-api/requirements, and competitor survey into\nkakoune-protocol-constraints Appendix A.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T13:12:26+09:00",
          "tree_id": "86cbf39fb14d6c1dbd0ccb7e416d6c66ef60efa3",
          "url": "https://github.com/Yus314/kasane/commit/c50f1cbbac35c4db35fb9b9c120d60f21de85b9e"
        },
        "date": 1773722368065,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d6b8aa91fa3d06696e5d4b376e402273d747590c",
          "message": "refactor: remove pane.rs dead code, extract surface tests, improve code quality\n\n- Remove pane.rs scaffold (~835 lines): move FocusDirection to workspace,\n  drop Command::Pane/DeferredCommand::Pane, remove 6 pane lifecycle methods\n  from PluginBackend, remove PANE_LIFECYCLE/PANE_RENDERER capability bits\n- Extract surface/mod.rs tests to integration test (tests/surface_registry.rs,\n  40 tests, ~1128 lines moved)\n- Add named constants in menu.rs (SCROLLBAR_WIDTH, PREFIX_WIDTH,\n  SUFFIX_RESERVE, MAX_DROPDOWN_HEIGHT) replacing magic numbers\n- Fix Clippy warnings: collapsible else-if in doctor.rs, #[cfg(test)] on\n  test-only function in templates.rs\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T13:22:42+09:00",
          "tree_id": "9d65a0e0418de3921c59fcfb3583dade5ac1b42a",
          "url": "https://github.com/Yus314/kasane/commit/d6b8aa91fa3d06696e5d4b376e402273d747590c"
        },
        "date": 1773723022253,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5727e0770afa44fe371bd1a76597630f48fa4064",
          "message": "docs: remove requirements-traceability.md, migrate resolution layer to layer-responsibilities.md\n\nR-series requirements are all complete (Phase 1-4a), D-series redirected\nto upstream-dependencies.md, and P-series tracked by roadmap.md workstreams.\nThe Resolution Layer classification (HOW) is now embedded in\nlayer-responsibilities.md alongside the Three-Layer Model (WHERE).\n\nUpdated 15 cross-references across 6 files.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T13:26:15+09:00",
          "tree_id": "9d561cf3100451389bc2003ee36939c103a4ad7e",
          "url": "https://github.com/Yus314/kasane/commit/5727e0770afa44fe371bd1a76597630f48fa4064"
        },
        "date": 1773723167690,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "15f54ec56e8528089a9f1748d5d89efdc315d286",
          "message": "docs: remove stale directory trees from repo-layout.md, update responsibility tables\n\nTree diagrams had 19 inaccuracies vs actual filesystem. Removed all 7\ntrees (150 lines) and kept responsibility tables which provide navigational\nvalue not derivable from `tree` command. Updated tables with missing\nentries: display/, session.rs, event_loop.rs, workspace/, event_handler.rs,\nsgr.rs, capability.rs. Added display transformation to §4 lookup table.\n\n302 → 116 lines (62% reduction).\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T13:40:40+09:00",
          "tree_id": "cb864768dddd1deacde8ee84d3f4b77975d18ce3",
          "url": "https://github.com/Yus314/kasane/commit/15f54ec56e8528089a9f1748d5d89efdc315d286"
        },
        "date": 1773724046949,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5992b271d11919f03b17e4f1b26565b1f137fafe",
          "message": "docs: restructure README to better reflect project vision\n\nReorganize sections to follow a natural reader journey (hook →\nevidence → action → depth → expectations). Key changes:\n\n- Rewrite intro to position Kasane as sitting between user and Kakoune\n- Replace \"What's Different\" with \"Out of the Box\" focusing on user\n  experience over feature listing\n- Move \"For Plugin Authors\" above \"Status\" to elevate extensibility\n  as a core value proposition\n- Reframe plugin section around Kakoune's -ui json protocol and\n  what becomes possible beyond terminal rendering constraints\n- Merge \"Installation\" into \"Quick Start\" for conciseness\n- Merge \"Documentation\" into \"Going Further\" with expanded links\n  including Plugin Development, Plugin API, and Vision\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T14:03:19+09:00",
          "tree_id": "dc3736464f9f3b0b314a3e94046ca3abc196d237",
          "url": "https://github.com/Yus314/kasane/commit/5992b271d11919f03b17e4f1b26565b1f137fafe"
        },
        "date": 1773725418551,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "a26068e1f966f7ba980e375155d97424067f86db",
          "message": "docs: remove glossary.md (all definitions exist in authoritative docs)\n\nEvery term in glossary.md is defined with more detail and context in\nsemantics.md, architecture.md, plugin-api.md, or layer-responsibilities.md.\nThe glossary added maintenance burden (sync with 6+ docs) and staleness\nrisk (hardcoded implementation details) without unique information value.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T14:08:02+09:00",
          "tree_id": "f5a2e90421675df59b3afc772ea1d0120854d8f2",
          "url": "https://github.com/Yus314/kasane/commit/a26068e1f966f7ba980e375155d97424067f86db"
        },
        "date": 1773725671260,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1ef21ec72c1b77f4d8db6298f057698d7df76260",
          "message": "docs: remove gpu-backend.md, distribute content to authoritative docs\n\ngpu-backend.md duplicated config.md (window/font/colors settings) and\nREADME/getting-started (build/usage commands). Distribute its unique\ncontent to where readers encounter it naturally:\n\n- Feature list → whats-different.md (GPU Backend section)\n- Prerequisites (GPU drivers, --features gui) → config.md (GUI Backend intro)\n- SSH limitation → compatibility.md (new GPU Backend section)\n- Config reference links → removed (config.md is authoritative)\n\nUpdate all 5 referring docs (README, index, whats-different,\ngetting-started, index classification list).\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T14:37:16+09:00",
          "tree_id": "df3ca556f7d83c868fcba2f5df31bd20cf2e415f",
          "url": "https://github.com/Yus314/kasane/commit/1ef21ec72c1b77f4d8db6298f057698d7df76260"
        },
        "date": 1773727438613,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "426299bf30eb6400a130a05cb4bfcfd56f060578",
          "message": "docs: remove compatibility.md and json-ui-protocol.md\n\ncompatibility.md: all content duplicated across troubleshooting.md,\ngetting-started.md, and whats-different.md. Terminal compatibility\ntable was unverified. No unique information.\n\njson-ui-protocol.md: protocol spec is a degraded copy of the Rust\ntype definitions in protocol/message.rs and protocol/color.rs.\nUpstream tracking duplicated upstream-dependencies.md.\n\nUpdate 6 referring documents and fix a duplicate link in\nkakoune-protocol-constraints.md.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T14:53:23+09:00",
          "tree_id": "75cf3532004fc156ab550fe2330249f1f55cb561",
          "url": "https://github.com/Yus314/kasane/commit/426299bf30eb6400a130a05cb4bfcfd56f060578"
        },
        "date": 1773728411671,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "289b1da8acfef994643fc1ddba4fd2884e12229c",
          "message": "docs: merge performance-benchmarks.md into performance.md, remove indirection layer\n\nperformance.md was a 56-line meta-document that only routed readers to\nperformance-benchmarks.md and profiling.md. Its 18 lines of unique content\n(principles) are now the preamble of performance.md. This removes one hop\nin the reader's navigation path (index → performance → profiling) and\neliminates a file whose self-declared update rule was \"only update if\nprinciples change\" — i.e., it was effectively immutable.\n\nReferences updated in: index.md, profiling.md, semantics.md, roadmap.md,\ndecisions.md (12 link updates total).\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T15:08:12+09:00",
          "tree_id": "bbcbf0e8fbd75b65b91f546e26bac8afae1325ac",
          "url": "https://github.com/Yus314/kasane/commit/289b1da8acfef994643fc1ddba4fd2884e12229c"
        },
        "date": 1773729334182,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "849c47318d737b887a3e7928f9042031aa012fce",
          "message": "fix(bench): update salsa benchmarks for ViewCache-free API\n\nRemove &mut ViewCache parameter from all salsa bench call sites to\nmatch the updated pipeline_salsa.rs signatures (d771c53).\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T15:22:32+09:00",
          "tree_id": "4e2db7f81ff22ce662597e7ca64b11613af6e220",
          "url": "https://github.com/Yus314/kasane/commit/849c47318d737b887a3e7928f9042031aa012fce"
        },
        "date": 1773730174262,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "846c9ea8c23e9534980607181a056b94f7441749",
          "message": "fix(test): update test_draw_no_cursors expectation for face-matching fallback\n\nThe face-matching fallback in detect_cursors always assumes at least\none cursor exists at cursor_pos (since Kakoune guarantees it). Update\nthe test to expect cursor_count=1 instead of 0, matching protocol reality.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T15:35:09+09:00",
          "tree_id": "4f0acf4037a044d219d344ec48ffd0297ed6c43c",
          "url": "https://github.com/Yus314/kasane/commit/846c9ea8c23e9534980607181a056b94f7441749"
        },
        "date": 1773730935614,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "aea5be7851da67e02c31d0cf88e1842345823c1a",
          "message": "docs: remove layer-responsibilities.md, distribute content to primary sources\n\nlayer-responsibilities.md duplicated information already present in\ndecisions.md (ADR-012, ADR-023), architecture.md, plugin-api.md, and\nwasm-constraints.md. Remove the file and relocate its two unique fragments:\n\n- Decision flowchart → architecture.md (inline after three-layer table)\n- API Validation table → decisions.md (new ADR-012 section 12-5)\n\nUpdate all 10 cross-references across 8 files.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T15:51:43+09:00",
          "tree_id": "04e2dbb085f72ff9e41984cb53e133d0889e2f45",
          "url": "https://github.com/Yus314/kasane/commit/aea5be7851da67e02c31d0cf88e1842345823c1a"
        },
        "date": 1773731927091,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "27e3d2e2106b5b6eae40a51271f489823f78dad0",
          "message": "docs: two-layer model for performance.md — auto-generated measurement tables\n\nSeparate ~200 hardcoded benchmark values into auto-generated tables\n(replaced by tools/update-measurements.sh) and hand-maintained analysis\ntext, using <!-- BENCH:name --> markers to define 26 replaceable regions.\n\nKey changes:\n- tools/bench-sections.json: benchmark-to-section mapping (26 sections)\n- tools/update-measurements.sh: marker replacement script (jq + awk)\n- docs/performance.md: insert markers, fix stale data (alloc 31→100,\n  SLO threshold 50→150), remove ~193 lines of resolved history\n- docs/decisions.md: receive ADR-010/015 implementation status, resolved\n  bottlenecks, 240Hz analysis, component macro details from performance.md\n- .github/workflows/bench.yml: add --check staleness detection step\n- alloc_budget.json: current allocation snapshot for CI comparison\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T18:05:26+09:00",
          "tree_id": "5b7b915947e882dd19648a3fcb0e3edc9b796faa",
          "url": "https://github.com/Yus314/kasane/commit/27e3d2e2106b5b6eae40a51271f489823f78dad0"
        },
        "date": 1773740292184,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "8b0d0bf0dabbb3a4322c4ceadbebf421aa7c42bd",
          "message": "chore: gitignore fifo-trace.log and alloc_budget.json\n\nBoth are generated artifacts: fifo-trace.log from protocol debugging,\nalloc_budget.json from `cargo run --bin alloc_budget`. CI generates\nalloc_budget.json on every run so it doesn't need to be tracked.\n\nCo-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>",
          "timestamp": "2026-03-17T18:07:33+09:00",
          "tree_id": "95e6ff293637633ddaf41f2c435e2eb2a91decc2",
          "url": "https://github.com/Yus314/kasane/commit/8b0d0bf0dabbb3a4322c4ceadbebf421aa7c42bd"
        },
        "date": 1773740399418,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "673f1611e161280f717e75c53825ac06a3460916",
          "message": "Merge pull request #1 from Yus314/pr/1-typed-authoring\n\n[plugin] make define_plugin typed-only",
          "timestamp": "2026-03-20T17:37:06+09:00",
          "tree_id": "6b8afe122baabe7fb4c0c141cb180c0f57fe7df2",
          "url": "https://github.com/Yus314/kasane/commit/673f1611e161280f717e75c53825ac06a3460916"
        },
        "date": 1773997767232,
        "tool": "cargo",
        "benches": [
