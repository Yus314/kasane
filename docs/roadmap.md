...
| β-3.3b.8-11 — WasmPlugin handler-family migrations | pending | Remaining per-family migrations (navigation/overlay/edit-intercept, persistence + workspace, process tasks + pubsub + lens, static metadata + cleanup) populating the same `register()`. See [`memory/project_phase_beta_3_3b_substaging.md`](../) for the breakdown. |
