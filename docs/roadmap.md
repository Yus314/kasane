...
| β-3.3b.6-11 — WasmPlugin handler-family migrations | pending | Remaining per-family migrations (annotations + ornaments, display + projections, navigation/overlay, persistence, process tasks/pubsub, static metadata) populating the same `register()`. See [`memory/project_phase_beta_3_3b_substaging.md`](../) for the breakdown. |
