...
| P8 — Bridge dispatch full mechanisation | Pending | Blocked on P4. Original P8 from ADR-039 — `dispatch_owner_inject!` macro for `bridge.rs` (1900 → ~700 LoC) — is independent of P7+P9 closure |
