...
| Phase W | WASM プラグインランタイム基盤 | ✓ 基盤完了 | follow-up は別表で継続追跡 |
...
| 5c 外部プラグイン候補 | Backlog | Open | E-003, E-004, E-010, E-011, E-012, E-022, E-023, E-031, E-041 を候補として維持 |

### 3.3 Phase W follow-ups

Phase W の基盤自体は完了しているが、運用面の follow-up は残っている。
