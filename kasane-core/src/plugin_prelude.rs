...
pub use crate::plugin::{
    ...
    ExtensionPointId, FaceMerge, FoldToggleState, GutterSide, HandlerRegistry, IsBridgedPlugin,
    KakouneSideCommand, KakouneSideEffects, KakouneTransparentCommand, KakouneTransparentEffects,
    KakouneTransparentKeyResult, KeyDispatchResult, KeyHandleResult, LifecyclePhase,
    LineAnnotation, NavigationAction, NavigationDirection, NavigationPolicy, NullEffects,
    ObservationEffects, OrnamentBatch, OrnamentModality, OverlayContext, OverlayContribution,
    PaneContext, Plugin, PluginAuthorities, PluginBackend, PluginBridge, PluginCapabilities,
    PluginDescriptor, PluginEffects, PluginFactory, PluginId, PluginManager, PluginProvider,
    PluginRank, PluginRevision, PluginRuntime, PluginSource, PluginState, ProcessCapableEffects,
    ProcessCommand, RecoveryMechanism, RecoveryWitness, RenderOrnamentContext,
    SafeDisplayDirective, SemanticRole, SlotId, SourceStrength, SurfaceOrn, SurfaceOrnAnchor,
    SurfaceOrnKind, Topic, TopicBus, TopicId, TransformContext, TransformDescriptor,
    TransformScope, TransformSubject, TransformTarget, Transparency, UnitSource, VirtualTextItem,
