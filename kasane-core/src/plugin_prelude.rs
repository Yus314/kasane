...
pub use crate::plugin::{
    ...
    IsBridgedPlugin, KakouneSideCommand, KakouneSideEffects, KakouneTransparentCommand,
    KakouneTransparentEffects, KakouneTransparentKeyResult, KeyDispatchResult, KeyHandleResult,
    LifecyclePhase, LineAnnotation, NavigationAction, NavigationDirection, NavigationPolicy,
    NullEffects, ObservationEffects, OrnamentBatch, OrnamentModality, OverlayContext,
    ...
    ProcessCapableEffects, ProcessCommand, RecoveryMechanism, RecoveryWitness,
