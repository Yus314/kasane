...
pub use crate::plugin::{
    ...
    IsBridgedPlugin, KakouneSafeCommand, KakouneSafeEffects, KakouneSafeKeyResult,
    KeyDispatchResult, KeyHandleResult, LifecyclePhase, LineAnnotation, NavigationAction,
    NavigationDirection, NavigationPolicy, NullEffects, OrnamentBatch, OrnamentModality,
    OverlayContext, OverlayContribution, PaneContext, Plugin, PluginAuthorities, PluginBackend,
    ...
    PluginState, RecoveryMechanism, RecoveryWitness, RenderOrnamentContext, SafeDisplayDirective,
    SemanticRole, SlotId, SourceStrength, SurfaceOrn, SurfaceOrnAnchor, SurfaceOrnKind, Topic,
    TopicBus, TopicId, TransformContext, TransformDescriptor, TransformScope, TransformSubject,
    TransformTarget, Transparency, UnitSource, VirtualTextItem, builtin_plugin,
