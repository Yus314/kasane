...
pub use crate::plugin::{
    ...
    ContributeContext, Contribution, CursorEffect, CursorEffectOrn, CursorStyleOrn,
    DecorationTarget, DisplayDirective, DisplayMapRef, DisplayUnit, DisplayUnitId, DisplayUnitMap,
    Effects, EffectsBatch, ElementPatch, ExtensionPointId, ExtensionResults, FaceMerge,
