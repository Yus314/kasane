...
pub use crate::plugin::{
    ...
    PaneContext, Plugin, PluginAuthorities, PluginBridge, PluginCapabilities, PluginDescriptor,
    PluginEffects, PluginFactory, PluginId, PluginManager, PluginProvider, PluginRank,
    PluginRevision, PluginRuntime, PluginSource, PluginState, ProcessCapableEffects,
