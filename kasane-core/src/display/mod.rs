...
///
/// Variant-name reflection (`variant_name`, `ALL_VARIANT_NAMES`,
/// `DESTRUCTIVE_VARIANTS`, `PRESERVING_VARIANTS`) is generated by
/// `#[derive(VariantMeta)]`. Tag a new variant with
/// `#[variant_meta(destructive)]` to add it to the destructive set.
#[derive(Debug, Clone, PartialEq, kasane_macros::VariantMeta)]
...
//
// `ALL_VARIANT_NAMES`, `DESTRUCTIVE_VARIANTS`, `PRESERVING_VARIANTS`, and
// `variant_name()` are emitted by `#[derive(VariantMeta)]` on the enum
// definition above. Manual maintenance of those arrays is no longer needed.
// =============================================================================
