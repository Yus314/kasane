...
impl ViewCache {
    ...
    pub fn invalidate(&mut self, dirty: DirtyFlags) {
        // These masks match the DEPS constants generated by #[kasane_component]:
        //   BUILD_BASE_DEPS = BUFFER | STATUS | OPTIONS
        //   BUILD_MENU_SECTION_DEPS = MENU_STRUCTURE | MENU_SELECTION
        //   BUILD_INFO_SECTION_DEPS = INFO
        self.base.invalidate(
            dirty,
            DirtyFlags::BUFFER | DirtyFlags::STATUS | DirtyFlags::OPTIONS,
        );
        self.menu_overlay.invalidate(dirty, DirtyFlags::MENU);
        self.info_overlays.invalidate(dirty, DirtyFlags::INFO);
    }
}
